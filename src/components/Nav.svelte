...
<!-- <nav class="navbar" role="navigation" arial-label="main navigation">
	<div class="navbar-brand">
		<a href="/" clss="navbar-item">
			<img src="logo-192.png" alt="virus">
		</a>
    ...
    <div class="relative flex items-center justify-between h-16">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        <!-- Mobile menu button-->
				<button 
				on:click={toggle}
				class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-expanded="false">
...
<!-- home  -->
            ...
            <a class:is-active={segment==='about'} href="/about" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
...
<!-- bell -->
  ...
  <!--
    ...
    Menu open: "block", Menu closed: "hidden"
  -->
  <div class="hidden sm:hidden" class:is-open = {isOpen}>
    <div class="px-2 pt-2 pb-3 space-y-1">
      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
			<a href="/" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium"
			on:click={toggle}>Home</a>
			<a href="/about" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
			on:click={toggle}>About</a>
